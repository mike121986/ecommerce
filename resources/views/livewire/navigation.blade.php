<header class="bg-sky-700 h-32 sticky top-0" style="z-index: 900" x-data="dropdown()">
    <div class="container flex items-center h-24 justify-between md:justify-start">
        <a  :class="{'bg-opacity-100 text-orange-500' : open}"
            x-on:click="show()"
            class="flex flex-col items-center justify-center order-last md:order-first px-6 md:px-4 bg-white bg-opacity-25 text-white cursor-pointer font-semibold h-32">
